...
$kas_siswa = mysqli_query($conn, "SELECT kas.nama, kas_masuk.jumlah, kas_masuk.keterangan, kas_masuk.tanggal_masuk
FROM kas_masuk
JOIN kas ON kas.id_kas = kas_masuk.id_kas
JOIN siswa ON kas_masuk.id_siswa = siswa.id_siswa
WHERE siswa.id_kelas = '{$_SESSION['id_kelas']}' AND siswa.id_siswa = '$id_siswa'");
